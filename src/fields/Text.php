...
class Text extends Abstract_Input {
  ...
  protected function _build_input() {
    ...
    <div class="input-wrapper text-input-wapper" data-showif='<?php echo $this->_conditional_data(); ?>'>
      <label for="<?php echo $this->_id; ?>"><?php echo $this->_label; ?></label>
      <input type="text" id="<?php echo $this->_id; ?>" class="input" name="<?php echo $this->_name; ?>" value="<?php echo $this->_value; ?>" placeholder="<?php echo $this->_label; ?>" <?php echo $this->_additional_attrs; ?>>
